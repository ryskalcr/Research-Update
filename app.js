...
function renderAdvisor() {
  ...
  return `<div class="sr-container-wide">
    ...
    <div class="sr-hidden-switch">
      <button class="sr-switch-btn" data-view="admin">Edit Data</button>
    </div>
  </div>`;
}
...
function renderAdmin() {
  ...
  return `<div class="sr-container" style="padding-bottom:100px">
    <div class="sr-admin-topbar">
      <button class="sr-back-btn" data-view="advisor">\u2190 Back to Advisor View</button>
      <span class="sr-admin-badge">Editing Mode</span>
    </div>
    <div class="sr-section">
...
// ─── Event Binding ───
function bind() {
  // View switcher buttons (hidden footer link + admin back button)
  document.querySelectorAll('[data-view]').forEach(btn => {
    btn.addEventListener('click', () => { state.view = btn.dataset.view; render(); window.scrollTo(0, 0); });
  });
